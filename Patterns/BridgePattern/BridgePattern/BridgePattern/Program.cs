...
namespace BridgePattern
{
    public class Program
    {
        public static void Main()
        {
            ...
            var license1 = new MovieLicense("Secret Life of Pets", now, LicenseType.TwoDays);
            var license2 = new MovieLicense("Matrix", now, LicenseType.LifeLong);

            PrintLicenseDetails(license1);
            PrintLicenseDetails(license2);

            var license3 = new MovieLicense("Secret Life of Pets", now, LicenseType.LifeLong, Discount.Military);
            var license4 = new MovieLicense("Matrix", now, LicenseType.TwoDays, Discount.Senior);

            PrintLicenseDetails(license3);
            PrintLicenseDetails(license4);

            var license5 = new MovieLicense("Matrix", now, LicenseType.TwoDays, Discount.Senior, SpecialOffer.TwoDaysExtension);
